    ...
    <div className="group relative px-2 py-1 w-full">
      <Popover.Root>
        <div className="flex items-center gap-2 justify-center w-full">
          <Popover.Trigger className="flex items-center justify-center gap-2 bg-transparent hover:bg-base-focus w-full h-full">
            <div
              className={clsx(
            ...
            ></div>
            <div className="text-base-content">{color.displayName}</div>
          </Popover.Trigger>
          <div
            className={clsx(
