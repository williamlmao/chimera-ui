...
12 25 -13 6 -16 11 -66 11 -112z"
      ...
      <div className="text-2xl font-semibold">Chimera UI</div>
    </div>
  ),
  docsRepositoryBase:
    "https://github.com/williamlmao/chimera-tw/tree/main/apps/docs",
  project: {
    link: "https://github.com/williamlmao/chimera-tw",
  },
  toc: {
  ...
  head: () => {
    ...
    return (
      <>
        <meta
          property="og:url"
          content={`https://https://chimera-tw-docs.vercel.app/${asPath}`}
        />
        <meta
          property="og:description"
          content={frontMatter.description || "A UI library "}
        />
      </>
    );
  },
