...
import { Popover, Input, Showcase } from "@chimera-ui/components";
import {
  InfoCircledIcon,
  Cross2Icon,
  MixerHorizontalIcon,
    ...
    <Popover buttonContent={<MixerHorizontalIcon />}>
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <fieldset className="Fieldset flex items-center justify-between gap-6">
          <label className="text-base-content-2" htmlFor="width">
            Width
          </label>
          <Input
        ...
        <fieldset className="Fieldset flex items-center justify-between gap-6">
          <label className="text-base-content-2" htmlFor="maxWidth">
            Max. width
          </label>
          <Input
            className="w-32 rounded-md border border-line"
        ...
        <fieldset className="Fieldset flex items-center justify-between gap-6">
          <label className="text-base-content-2" htmlFor="height">
            Height
          </label>
          <Input
            className="w-32 rounded-md border border-line"
        ...
        <fieldset className="Fieldset flex items-center justify-between gap-6">
          <label className="text-base-content-2" htmlFor="maxHeight">
            Max. height
          </label>
          <Input
            className="w-32 rounded-md border border-line"
