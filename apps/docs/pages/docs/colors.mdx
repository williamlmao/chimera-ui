import { ColorTable, colorSystem } from "@/components/ColorTables";
...
<details>
  <summary>**content, content-contrast** (e.g.,  primary-content, text-base-content-) </summary>
...
![Content Example](../../public/content-example.png)
