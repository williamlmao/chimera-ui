 ...
 *
 * secondary-outline: bg-transparent border border-secondary text-secondary hover:bg-secondary-focus hover:text-secondary-content
 *
 * secondary-subtle: bg-secondary-subtle text-secondary-subtle-content hover:bg-secondary hover:text-secondary-content
 *
 * destructive: bg-danger text-danger-content hover:bg-danger-focus
 *
 * info: bg-info text-info-content hover:bg-info-focus
 ...
 * warning: bg-warning text-warning-content hover:bg-warning-focus
 *
 * outline: bg-transparent border border-primary text-primary hover:bg-primary-focus hover:text-primary-content
 *
 * subtle: bg-primary-subtle text-primary-subtle-content hover:bg-primary hover:text-primary-content
 *
 * ghost: bg-transparent hover:bg-base-2    data-[state=open]:bg-transparent
 *
 * link: bg-transparent underline-offset-4 hover:underline text-slate-900  hover:bg-transparent
 *
