 ...
 * @param className Default: `w-fit flex items-center justify-center relative group px-4 py-2 tracking-wide bg-primary text-on-primary rounded-theme transition duration-100 ease-in-out`
