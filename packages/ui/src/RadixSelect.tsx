...
export const RadixSelect = ({
  ...
  return (
    ...
    >
      ...
      <Select.Portal>
        <Select.Content className="SelectContent bg-overlay text-on-surface p-1 rounded-theme">
...
const SelectItem = ({ item }: { item: Item }) => {
  return (
    <Select.Item
      value={item.value}
      className=" relative  flex items-center px-4 py-1 rounded-theme text-sm hover:bg-primary hover:text-on-primary hover:cursor-pointer"
